...
** Last update Sun Jan  8 03:04:59 2017 Antoine Baché
*/
...
static void	Int64_t_set(Object *self, ...)
{
  Int64_tClass	*obj;
  va_list	ap;
...
static Int64_tClass _description =
{
  {
      {
	sizeof(Int64_tClass), "Int64_t", &Int64_t_ctor, &Int64_t_dtor, &Int64_t_set,
