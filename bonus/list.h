...
typedef void (*clear_t)(ListClass *self);
typedef void (*reverse_t)(ListClass *self);
...
# define clear(c)		(((ListClass*) c)->__clear__(c))
# define reverse(c)		(((ListClass*) c)->__reverse__(c))
